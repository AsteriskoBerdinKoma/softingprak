...
public interface RemoteObservable extends Remote
{
	/** Adds an observer to the list of observers watching a particular object, 
	  ...
	  */
	public void addObserver( RemoteObserver o, Object of_interest ) throws RemoteException;

	/** Removes an observer from the list of observers watching a particular 
	  * item of interest.
	  */
	public void deleteObserver( RemoteObserver o, Object of_interest ) throws RemoteException;
	...
	/** Removes all observers.
	  */
	public void deleteAllObservers() throws RemoteException;
	...
	/** Notifies any observers watching the object <tt>of_interest</tt> within this
	  ...
	  */
	public void notifyObservers( Object of_interest, Object arg ) throws RemoteException;
	...
	/** Notifies any observers watching the object <tt>of_interest</tt> within this
	  ...
	  * @param of_interest An object within this observable. This parameter must not be <tt>null</tt>.
	  */
	public void notifyObservers( Object of_interest ) throws RemoteException;
